...
//@WebServlet(urlPatterns="demo/showdate")
public class LoginServlet  extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp)
		...
		//JDBC
		if(username.equals("harsha")&&password.equals("test123"))
		{	//Retrun Output
		...
		}else
		{
			...
			req.setAttribute("error", "username and pasword are invalid plz try again..");
			rd.forward(req, resp);
		}
